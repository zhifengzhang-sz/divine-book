...
export function addSemantics(s: ohm.Semantics): void {
	...
	s.addOperation<Effect[]>("toEffects", {
		...
		fx_tianMingYouGui(_sbstd, _s, _bsbstzcdshts, varRef, _p) {
			return [{ type: "probability_to_certain" }, { type: "damage_increase", value: varRef.extractVar }];
		},
		fx_jingXingTianYou(_bst, _s, _hsbcsthdxyry, _colon, _gjts, v1, _p1, _s2, _zmshts, v2, _p2, _s3, _zcdsshts, v3, _p3) {
