...
export function addSemantics(s: ohm.Semantics): void {
	...
	s.addOperation<Effect[]>("toEffects", {
		...
		stateBody(_tisheng, varRef, _pct, _zzshjs, _sep, _chixu, durVar, _miao) {
			return [{ type: "self_buff", final_damage_bonus: varRef.extractVar, duration: durVar.extractVar }];
		},
		primaryAffix(_zsmyy, varRef1, _pct1, _zzshjs, _sep1, _btjfj, varRef2, _pct2, _gkldsh, _sep2, _zdjsz, varRef3, _pct3, _zzshjs2) {
			return [{ type: "conditional_hp_scaling", hp_threshold: varRef1.extractVar, value: varRef2.extractVar, max: varRef3.extractVar }];
		},
