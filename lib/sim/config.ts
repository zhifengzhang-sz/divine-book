 ...
 *
 * Validates book/affix references against YAML data,
 * selects effect tiers based on progression.
 *
 * YAML loading moved to ../data/store.ts — re-exported here for
...
// Re-export from data/store.ts for backward compatibility
export {
	loadBooksYaml,
	loadAffixesYaml,
	type BooksYaml,
...
import type { BooksYaml, AffixesYaml } from "../data/store.js";
